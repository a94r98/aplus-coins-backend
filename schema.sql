...
CREATE TABLE IF NOT EXISTS countries (
    ...
    dial_code VARCHAR(20) DEFAULT '+1',
...
INSERT INTO countries (code, name, dial_code, flag, is_active) VALUES
('IQ', 'العراق (Iraq)', '+964', '🇮🇶', TRUE),
('SA', 'السعودية (Saudi Arabia)', '+966', '🇸🇦', TRUE),
('AE', 'الإمارات (UAE)', '+971', '🇦🇪', TRUE),
('TR', 'تركيا (Turkey)', '+90', '🇹🇷', TRUE),
('EG', 'مصر (Egypt)', '+20', '🇪🇬', TRUE),
('JO', 'الأردن (Jordan)', '+962', '🇯🇴', TRUE),
('LB', 'لبنان (Lebanon)', '+961', '🇱🇧', TRUE),
('SY', 'سوريا (Syria)', '+963', '🇸🇾', TRUE),
('PS', 'فلسطين (Palestine)', '+970', '🇵🇸', TRUE),
('KW', 'الكويت (Kuwait)', '+965', '🇰🇼', TRUE),
('QA', 'قطر (Qatar)', '+974', '🇶🇦', TRUE),
('OM', 'عمان (Oman)', '+968', '🇴🇲', TRUE),
('BH', 'البحرين (Bahrain)', '+973', '🇧🇭', TRUE),
('YE', 'اليمن (Yemen)', '+967', '🇾🇪', TRUE),
('LY', 'ليبيا (Libya)', '+218', '🇱🇾', TRUE),
('SD', 'السودان (Sudan)', '+249', '🇸🇩', TRUE),
('MA', 'المغرب (Morocco)', '+212', '🇲🇦', TRUE),
('DZ', 'الجزائر (Algeria)', '+213', '🇩🇿', TRUE),
('TN', 'تونس (Tunisia)', '+216', '🇹🇳', TRUE),
('MR', 'موريتانيا (Mauritania)', '+222', '🇲🇷', TRUE),
('SO', 'الصومال (Somalia)', '+252', '🇸🇴', TRUE),
('DJ', 'جيبوتي (Djibouti)', '+253', '🇩🇯', TRUE),
('KM', 'جزر القمر (Comoros)', '+269', '🇰🇲', TRUE),
('US', 'الولايات المتحدة (USA)', '+1', '🇺🇸', TRUE),
('GB', 'المملكة المتحدة (UK)', '+44', '🇬🇧', TRUE),
('CA', 'كندا (Canada)', '+1', '🇨🇦', TRUE),
('AU', 'أستراليا (Australia)', '+61', '🇦🇺', TRUE),
('DE', 'ألمانيا (Germany)', '+49', '🇩🇪', TRUE),
('FR', 'فرنسا (France)', '+33', '🇫🇷', TRUE),
('IT', 'إيطاليا (Italy)', '+39', '🇮🇹', TRUE),
('ES', 'إسبانيا (Spain)', '+34', '🇪🇸', TRUE),
('IN', 'الهند (India)', '+91', '🇮🇳', TRUE),
('PK', 'باكستان (Pakistan)', '+92', '🇵🇰', TRUE),
('BD', 'بنجلاديش (Bangladesh)', '+880', '🇧🇩', TRUE),
('ID', 'إندونيسيا (Indonesia)', '+62', '🇮🇩', TRUE),
('MY', 'ماليزيا (Malaysia)', '+60', '🇲🇾', TRUE),
('PH', 'الفلبين (Philippines)', '+63', '🇵🇭', TRUE),
('SG', 'سنغافورة (Singapore)', '+65', '🇸🇬', TRUE),
('NL', 'هولندا (Netherlands)', '+31', '🇳🇱', TRUE),
('BE', 'بلجيكا (Belgium)', '+32', '🇧🇪', TRUE),
('CH', 'سويسرا (Switzerland)', '+41', '🇨🇭', TRUE),
('SE', 'السويد (Sweden)', '+46', '🇸🇪', TRUE),
('NO', 'النرويج (Norway)', '+47', '🇳🇴', TRUE),
('DK', 'الدنمارك (Denmark)', '+45', '🇩🇰', TRUE),
('FI', 'فنلندا (Finland)', '+358', '🇫🇮', TRUE),
('IE', 'أيرلندا (Ireland)', '+353', '🇮🇪', TRUE),
('NZ', 'نيوزيلندا (New Zealand)', '+64', '🇳🇿', TRUE),
('RU', 'روسيا (Russia)', '+7', '🇷🇺', TRUE),
('CN', 'الصين (China)', '+86', '🇨🇳', TRUE),
('JP', 'اليابان (Japan)', '+81', '🇯🇵', TRUE),
('KR', 'كوريا الجنوبية (South Korea)', '+82', '🇰🇷', TRUE),
('BR', 'البرازيل (Brazil)', '+55', '🇧🇷', TRUE),
('MX', 'المكسيك (Mexico)', '+52', '🇲🇽', TRUE),
('AR', 'الأرجنتين (Argentina)', '+54', '🇦🇷', TRUE),
('CO', 'كولومبيا (Colombia)', '+57', '🇨🇴', TRUE),
('ZA', 'جنوب أفريقيا (South Africa)', '+27', '🇿🇦', TRUE),
('NG', 'نيجيريا (Nigeria)', '+234', '🇳🇬', TRUE),
('KE', 'كينيا (Kenya)', '+254', '🇰🇪', TRUE),
('GH', 'غانا (Ghana)', '+233', '🇬🇭', TRUE),
('AF', 'أفغانستان (Afghanistan)', '+93', '🇦🇫', TRUE),
('AL', 'ألبانيا (Albania)', '+355', '🇦🇱', TRUE),
('AM', 'أرمينيا (Armenia)', '+374', '🇦🇲', TRUE),
('AO', 'أنغولا (Angola)', '+244', '🇦🇴', TRUE),
('AT', 'النمسا (Austria)', '+43', '🇦🇹', TRUE),
('AZ', 'أذربيجان (Azerbaijan)', '+994', '🇦🇿', TRUE),
('BY', 'بيلاروسيا (Belarus)', '+375', '🇧🇾', TRUE),
('BO', 'بوليفيا (Bolivia)', '+591', '🇧🇴', TRUE),
('BA', 'البوسنة والهرسك (Bosnia)', '+387', '🇧🇦', TRUE),
('BG', 'بلغاريا (Bulgaria)', '+359', '🇧🇬', TRUE),
('CL', 'تشيلي (Chile)', '+56', '🇨🇱', TRUE),
('CR', 'كوستاريكا (Costa Rica)', '+506', '🇨🇷', TRUE),
('HR', 'كرواتيا (Croatia)', '+385', '🇭🇷', TRUE),
('CY', 'قبرص (Cyprus)', '+357', '🇨🇾', TRUE),
('CZ', 'التشيك (Czech Republic)', '+420', '🇨🇿', TRUE),
('EC', 'الإكوادور (Ecuador)', '+593', '🇪🇨', TRUE),
('EE', 'إستونيا (Estonia)', '+372', '🇪🇪', TRUE),
('GE', 'جورجيا (Georgia)', '+995', '🇬🇪', TRUE),
('GR', 'اليونان (Greece)', '+30', '🇬🇷', TRUE),
('HK', 'هونج كونج (Hong Kong)', '+852', '🇭🇰', TRUE),
('HU', 'المجر (Hungary)', '+36', '🇭🇺', TRUE),
('IS', 'أيسلندا (Iceland)', '+354', '🇮🇸', TRUE),
('IR', 'إيران (Iran)', '+98', '🇮🇷', TRUE),
('KZ', 'كازاخستان (Kazakhstan)', '+7', '🇰🇿', TRUE),
('LV', 'لاتفيا (Latvia)', '+371', '🇱🇻', TRUE),
('LT', 'ليتوانيا (Lithuania)', '+370', '🇱🇹', TRUE),
('LU', 'لوكسمبورغ (Luxembourg)', '+352', '🇱🇺', TRUE),
('MT', 'مالطا (Malta)', '+356', '🇲🇹', TRUE),
('NP', 'نيبال (Nepal)', '+977', '🇳🇵', TRUE),
('PE', 'بيرو (Peru)', '+51', '🇵🇪', TRUE),
('PL', 'بولندا (Poland)', '+48', '🇵🇱', TRUE),
('PT', 'البرتغال (Portugal)', '+351', '🇵🇹', TRUE),
('RO', 'رومانيا (Romania)', '+40', '🇷🇴', TRUE),
('SK', 'سلوفاكيا (Slovakia)', '+421', '🇸🇰', TRUE),
('SI', 'سلوفينيا (Slovenia)', '+386', '🇸🇮', TRUE),
('LK', 'سريلانكا (Sri Lanka)', '+94', '🇱🇰', TRUE),
('TH', 'تايلاند (Thailand)', '+66', '🇹🇭', TRUE),
('UA', 'أوكرانيا (Ukraine)', '+380', '🇺🇦', TRUE),
('UY', 'أوروغواي (Uruguay)', '+598', '🇺🇾', TRUE),
('UZ', 'أوزبكستان (Uzbekistan)', '+998', '🇺🇿', TRUE),
('VE', 'فنزويلا (Venezuela)', '+58', '🇻🇪', TRUE),
('VN', 'فيتنام (Vietnam)', '+84', '🇻🇳', TRUE)
